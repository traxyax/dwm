...
static const char *fonts[]          = {
	"Monofur Nerd Font:size=20",
	"agave Nerd Font:size=20",
...
/* tagging */
static const char *tags[] = { "DEV", "WWW", "WRK", "TRM", "GFX", "VEO", "BOX", "OER" };
...
static const Rule rules[] = {
	...
	{ "firefox",  NULL,       NULL,       1 << 3,       1,0,           -1,        0  },
	{ "brave-browser",  NULL,       NULL,       1 << 1,       1,0,           -1,        0  },
	{ "qutebrowser",  NULL,       NULL,       1 << 1,       1,0,           -1,        0  },
	{ NULL,       NULL,       "st",            1 << 3,       1,0,           -1,        0  },
...
//static const char *scratchpadcmd[] = {"s", "tabbed", "-f", "-r", "2", "-g", "1915x600", "st", "-w", "''", "-t", "scratchpad", NULL}; 
static const char *scratchpadcmd[] = {"s", "tabbed", "-f", "-r", "2", "-g", "1000x800+450+140", "st", "-w", "''", "-t", "scratchpad", NULL}; 

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ ALTKEY,                       XK_F1,      spawn,          SHCMD("dmenu_run -c -n -F -l 10 -g 2 -h 48") },
